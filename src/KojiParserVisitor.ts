...
import { FuriganaTargetContext } from "./KojiParser";
...
export interface KojiParserVisitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by `KojiParser.postPositionedAttrs`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitPostPositionedAttrs?: (ctx: PostPositionedAttrsContext) => Result;
	...
	/**
	 * Visit a parse tree produced by `KojiParser.furiganaTarget`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitFuriganaTarget?: (ctx: FuriganaTargetContext) => Result;
